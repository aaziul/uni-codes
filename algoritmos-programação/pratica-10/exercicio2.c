//OBJETIVO: recebeer o tamanho do arranjo e após ler os elementos do arranjo. Depois chamar a função e imprimir na tela o arranjo (com duas casas decimais) e a quantidade de elementos modificados
...
int main(){
    ...
    } else { //senão, avisa que o valor informado ultrapassou o valor máximo
        printf("Valor informado maior que o tamamnho maximo!");
    }

    //atribui a variavel trocados à função GeraValorPositivo
